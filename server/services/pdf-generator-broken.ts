...
export async function generatePdf(
  ...
  try {
    ...
    // Set content with reduced timeout
    await page.setContent(styledHtml, {
      waitUntil: 'domcontentloaded',
      timeout: 15000
    });
    
    // Add smart table classes based on column count - SIMPLIFIED
    try {
      await page.evaluate(() => {
      ...
      console.log('Table styling skipped due to timeout');
    }
    
    // Add custom CSS for table sizing
